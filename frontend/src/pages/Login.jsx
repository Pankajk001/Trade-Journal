...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#060606] [html:not(.dark)_&]:bg-slate-50 px-4">
      ...
      >
        <h2 className="text-3xl font-bold text-white [html:not(.dark)_&]:text-slate-900 mb-6 text-center">Welcome Back</h2>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#060606] border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-orange-500 transition-colors [html:not(.dark)_&]:bg-white [html:not(.dark)_&]:border-slate-300 [html:not(.dark)_&]:text-slate-900"
              required
            />
          </div>
          <div>
