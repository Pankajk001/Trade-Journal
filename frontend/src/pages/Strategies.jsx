          ...
          {strategies.map((strategy) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4 pr-6">
                ...
                <span className={`text-xs px-2 py-1 rounded border ${strategy.status === 'Active' ? 'bg-gray-800 text-green-400 border-green-500/20' :
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-gray-800 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-gray-700/50 w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh]"
            >
              {/* Modal Header */}
              ...
              <div className="p-6 overflow-y-auto custom-scrollbar">
                <form id="strategy-form" onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-white font-bold text-lg mb-4 border-b border-gray-700/50 pb-2">Strategy Overview</h3>
                    <FormInput
                  ...
                  <div className="space-y-4">
                    <h3 className="text-white font-bold text-lg mb-4 border-b border-gray-700/50 pb-2">Execution Framework</h3>
                    <NumberedListInput
            ...
            >
              <div className="p-6 border-b border-gray-700/50 flex justify-between items-center">
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    <span className={`text-xs px-2 py-1 rounded border ${selectedStrategy.status === 'Active' ? 'bg-gray-800 text-green-400 border-green-500/20' :
              ...
              <div className="p-6 overflow-y-auto custom-scrollbar space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-gray-900/80 p-5 rounded-xl border border-gray-700/50 shadow-inner">
